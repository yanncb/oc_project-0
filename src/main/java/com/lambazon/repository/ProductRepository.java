...
public class ProductRepository {
	...
	private static void generateProductData() {
		...
		products.put(++id, new Product(id, 60, 100.00, "Beatsx", "Earphone")); //Add new product Beatsx
		products.put(++id, new Product(id, 70, 250.00, "Beats Studio3 Wireless", "Head Phone")); // Add new product Beats Studio3
